...
@WebServlet("/VerifyDeptSignupOtpServlet")
public class VerifyDeptSignupOtpServlet extends HttpServlet {
        ...
        if (enteredOtp != null && enteredOtp.equals(correctOtp)) {
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement(
                    "INSERT INTO department (name, email, phone_num, status) VALUES (?, ?, ?, 1)"
                );
                ps.setString(1, name);
