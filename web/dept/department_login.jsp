...
<head>
   ...
   <script>
    function sendOTP(event) {
        ...
        xhr.open("POST", "/library_management_system/dept/SendDeptLoginOtpServlet", true);
...
<div class="card">
    ...
    <!-- Form -->
<form action="/library_management_system/dept/VerifyDeptLoginOtpServlet" method="post" onsubmit="return validateOTP();">
        <!-- Email -->
