...
<html>
    ...
    <body style="background: linear-gradient(135deg, #f2f2f2, #e6e6e6);">
        <div class="container mt-5">
            <h2 class="text-center mb-4">Book Reservation Report</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <%
                                ...
                                int status = rs.getInt("request_status");
                                switch (status) {
                                    case 0:
                            ...
                            <td><%= rs.getDate("due_date") != null ? rs.getDate("due_date") : "—"%></td>     </tr>
                            <%
                                }
                            %>
                    </tbody>
